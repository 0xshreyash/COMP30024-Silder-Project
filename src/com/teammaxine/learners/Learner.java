...
public abstract class Learner {
	...
	public int playGame(SliderPlayer horizontal, SliderPlayer vertical, int size) {
        ...
        timer.start();
        players[Player.H] = horizontal;
        players[Player.H].init(size, board.toString(), 'H');
        times[Player.H] += timer.clock();

        timer.start();
        players[Player.V] = vertical;
        players[Player.V].init(size, board.toString(), 'V');
